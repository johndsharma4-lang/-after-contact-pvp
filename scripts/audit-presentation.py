...
checks = {
    ...
    'canon low damage cannot remove cutaway doors': 'skin.userData.acDamagePresentationParts||[]' in base and 'bayDoors=STATE_OWNED fixedFrame=PRESERVED' in base and 'panel.userData.structureHpHidden=false' in base,
