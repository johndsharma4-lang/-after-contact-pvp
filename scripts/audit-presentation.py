...
checks = {
    ...
    'canon stepped silhouette has solid jointed prow': 'AURELIAN_CANON_COMMAND_ROOF' in canon_authority and 'AURELIAN_CANON_VENTRAL_KEEL' in canon_authority and 'AURELIAN_CANON_PROW_CORE' in canon_authority and 'AURELIAN_CANON_PROW_JOINT_CORE' in canon_authority,
