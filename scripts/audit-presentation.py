...
checks = {
    ...
    'aurelian uses player sketch layout': 'buildAurelianDirectorHull' in base and "layout=${sketchLayout?.length===6?'PLAYER_SKETCH_STACKED':'2x3'}" in base and 'acCutawayBayLayout=specs.map' in base,
    'pilot cockpit and solar cannon modules exist': 'AURELIAN_PILOT_OVAL_WINDOW' in base and 'AURELIAN_PILOT_SILHOUETTE_BODY' in base and 'AURELIAN_SOLAR_CANNON_BREECH' in base and 'AURELIAN_SOLAR_CANNON_BARREL' in base and 'AURELIAN_SOLAR_CANNON_MUZZLE' in base,
    ...
    'aurelian closure restores original module objects': 'if(visual.exteriorPanel)visual.exteriorPanel.visible=!open' in base and 'exteriorAuthority=ORIGINAL_SIX_MODULE_HULL' in director and 'originalExteriorModules=' in director,
    ...
    'v0418 build marker': 'MATCH RECORDER v0.41.8' in director and '2026-09-07_PLAYER_SKETCH_SIX_MODULE_HULL' in director,
}
