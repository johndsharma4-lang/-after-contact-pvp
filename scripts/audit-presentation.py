...
checks = {
    ...
    'six bays have faction-specific readable interiors': 'const bayPalette=' in base and 'CUTAWAY_BAY_RECESSED_WALL_' in base and 'CUTAWAY_BAY_BACKLIGHT_' in base,
    ...
    'aurelian model artwork upgraded': 'ac-aurelian-rebuilt-models-v0416' in rebuilt_models and 'solarCollar' in rebuilt_models and 'chestFiligree' in rebuilt_models and 'DISTINCT_SILHOUETTES' in rebuilt_models,
    'aurelian rigs enlarged and relit': 'ac-aurelian-cutaway-composition-v0416' in cutaway_composition and 'multiplyScalar(.76)' in cutaway_composition and 'SIX_BAY_HIGH_DETAIL_READABLE' in cutaway_composition,
    'v0416 build marker': 'MATCH RECORDER v0.41.6' in director and '2026-09-07_EXACT_HULL_HIGH_DETAIL_CREW' in director,
}
