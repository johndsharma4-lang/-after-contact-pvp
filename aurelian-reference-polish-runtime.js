...
export function patchAurelianReferencePolishRuntime(html){
  ...
  patched=patched.replace(/MATCH RECORDER v0\.\d+\.\d+/g,'MATCH RECORDER v0.47.0');
  patched=patched.replace(/build=2026-\d{2}-\d{2}_[A-Z0-9_-]+/g,'build=2026-09-12_COMBAT_CLARITY_DAMAGE_PASS');
  patched=patched.replace(/build=v0\.\d+\.\d+ panels=6 apertures=6/g,'build=v0.47.0 panels=6 apertures=6');
  return patched.replace('</head>','<meta id="ac-aurelian-reference-polish-v0470" name="ac-aurelian-reference-polish" content="sourceLevel:Y doorSculpt:3_LAYER ivoryAccents:5 exhausts:PRESERVED apertures:UNCHANGED combat:CLARITY_DAMAGE_PASS">\n</head>');
}
